...
/* harmony import */ var _simple_datatables__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_simple_datatables__WEBPACK_IMPORTED_MODULE_0__);
...
(function () {
  ...
  // Demo Datepicker
  var myDatepicker = function myDatepicker() {
    // Datepicker
    var date_datepick = document.querySelectorAll('.datepick');
    if (date_datepick != null) {
      for (var i = 0; i < date_datepick.length; i++) {
    ...
    // Range Datepicker
    var date_start = document.querySelectorAll('.startDate');
    if (date_start != null) {
      var date_end = document.querySelectorAll('.endDate');
      for (var _i = 0; _i < date_start.length; _i++) {
        for (var x = 0; x < date_end.length; x++) {
          flatpickr(date_start[_i], {
            enableTime: true,
            allowInput: true,
  ...
  // Preloader
  var myPreloader = function myPreloader() {
  ...
  // Tables sorter
  var myTablesorter = function myTablesorter() {
    var els = document.querySelectorAll(".table-sorter");
    if (els != null) {
      for (var i = 0; i < els.length; i++) {
        var table = new _simple_datatables__WEBPACK_IMPORTED_MODULE_0__.DataTable(els[i]);
      }
    }
  };
  ...
  var myValidation = function myValidation() {
    ...
    var valid_form = document.querySelectorAll(".valid-form");
    if (valid_form != null) {
      var _loop = function _loop() {
        var pristine = new Pristine(valid_form[i]);
  ...
  // Input tags
  var myTagify = function myTagify() {
    // tagify
    var input_tags = document.querySelectorAll("input.tagify");
    if (input_tags != null) {
  ...
  // Circle progress
  var myCircleProgress = function myCircleProgress() {
  ...
  // Custom JS
  var myCustom = function myCustom() {
